...
const BookReview = () => {
  ...
  useEffect(() => {
    const fetchBook = async () => {
      try {
        const res = await fetch(`https://readlybackend.vercel.app/books/get/${id}`);
    ...
    const fetchReviews = async () => {
      try {
        const res = await fetch(`https://readlybackend.vercel.app/reviews/get/${id}`);
        const data = await res.json();
        setReviews(data);
      } catch (err) {
    ...
    const checkOwnership = async () => {
      try {
        const res = await fetch(`https://readlybackend.vercel.app/rzpay/check/${userId}/${id}`);
        const data = await res.json();
